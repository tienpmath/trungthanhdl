          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="align-center flex max-w-xl flex-wrap justify-center gap-2 leading-8">
              ...
              <li>
                ...
                >
                  <h6>Tour Săn thăm quan nội thành Đà Lạt </h6>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <h6> Tour Săn thăm quan ngoại thành Đà Lạt </h6>
                </a>
              </li>
            </ul>
            ...
            <nav className="border-gray-lighter order-1 border-b pb-4 md:order-none md:border-b-0 md:pb-0">
              <ul className="flex flex-wrap items-center justify-center md:justify-end">
                <li className="px-4 first:pl-0 last:pr-0 lg:px-6">
                  <Link
                    href=""
                    className="text-primary 3xl:text-base block text-sm font-normal capitalize leading-4"
                  >
